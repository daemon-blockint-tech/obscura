  ...
  return (
    <div className="rounded-xl bg-obscura-surface border border-obscura-surface-variant overflow-hidden">
      <div className="flex items-center gap-2 px-5 py-4 border-b border-obscura-surface-variant">
        <ArrowUp size={16} weight="bold" className="text-obscura-primary" />
        <h2 className="text-sm font-semibold text-obscura-on-surface tracking-tight">Shielded Withdraw</h2>
      </div>

      <div className="p-5 space-y-5">
        <p className="text-xs text-obscura-on-surface-variant leading-relaxed">
          Withdraw from the shielded pool to a fresh address. ZK proof breaks the link to your deposit.
        </p>
        ...
        <div className="flex flex-col gap-2">
          <label className="text-xs font-medium text-obscura-on-surface-variant">Recipient Address</label>
          <input
            type="text"
            value={recipient}
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 rounded-lg border border-obscura-surface-variant bg-transparent px-4 py-3 text-sm font-semibold text-obscura-on-surface transition-all hover:border-obscura-on-surface-variant active:scale-[0.98] active:-translate-y-[1px] disabled:opacity-40 disabled:cursor-not-allowed"
        >
